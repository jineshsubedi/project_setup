...
<div class="wrapper">
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Jinesh Subedi</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="{{asset('backend/images/user.jpg')}}" class="img-circle" alt="User Image">

                <p>
                  Jinesh Subedi - Web Developer
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active-new">
          <a href="http://www.jineshsubedi.com.np">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; <?php echo date('Y'); ?> <a href="http://www.jineshsubedi.com.np">jinesh subedi</a>.</strong> All rights
    reserved.
  </footer>
</div>
